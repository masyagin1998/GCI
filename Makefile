...
$(VIRTUAL_MACHINE_OBJS_PREFIX)%.o: $(VIRTUAL_MACHINE_SRC_PREFIX)%.c $(VIRTUAL_MACHINE_SRC_PREFIX)virtual-machine.h
	...
	$(CC) $(CFLAGS) -I$(UTILS_SRC_PREFIX) -I$(LEXER_SRC_PREFIX) -I$(PARSER_SRC_PREFIX) -I$(BYTECODE_GENERATOR_SRC_PREFIX) -c $< -o $@
...
$(INTERPETER_OBJS_PREFIX)%.o: $(INTERPETER_SRC_PREFIX)%.c
	...
	$(CC) $(CFLAGS) -I$(UTILS_SRC_PREFIX) -I$(LEXER_SRC_PREFIX) -I$(PARSER_SRC_PREFIX) -I$(BYTECODE_GENERATOR_SRC_PREFIX) -I$(VIRTUAL_MACHINE_SRC_PREFIX)  -c $< -o $@

$(BIN_PREFIX)interpreter: $(INTERPETER_OBJS) $(UTILS_LIB) $(LEXER_LIB) $(PARSER_LIB) $(BYTECODE_GENERATOR_LIB) $(VIRTUAL_MACHINE_LIB)
	mkdir -p $(BIN_PREFIX)
	$(CC) $(CFLAGS) $^ -o $@
